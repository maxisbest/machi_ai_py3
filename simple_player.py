...
class SimpPlayer(object):
    def __init__(self, game, order, name=''):
        ...
        self.coins = 3
        self.order = order
        self.shared_ai = False  #不设置shared_ai, 自己去设置
    ...
    def load_ai(self):
        ...
        print('loaded ai from project_root_dir.')
    ...
    def decide_steal(self):
        ...
        #这里为何不调用record_steal? 因为会在calculate_purple(self)中调用。
